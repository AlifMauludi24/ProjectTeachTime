...
import id.sch.smktelkom_mlg.project.xirpl202112029.projectta.model.Alarm;
import id.sch.smktelkom_mlg.project.xirpl202112029.projectta.model.AlarmMsg;
import id.sch.smktelkom_mlg.project.xirpl202112029.projectta.model.AlarmTime;
import id.sch.smktelkom_mlg.project.xirpl202112029.projectta.model.DbHelper;
...
//	private static final String TAG = "AddAlarmActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Tambahkan Waktu Mengajar");
...
//		outState.putInt("min", timePicker.getCurrentMinute());
        outState.putCharSequence("Dari Tanggal", fromdateText.getText());
        outState.putCharSequence("Ke Tanggal", todateText.getText());
        outState.putCharSequence("Pada Waktu", attimeText.getText());
    }
...
//		timePicker.setCurrentMinute(state.getInt("min"));
        fromdateText.setText(state.getCharSequence("Dari Tanggal"));
        todateText.setText(state.getCharSequence("Ke Tanggal"));
        attimeText.setText(state.getCharSequence("Pada Waktu"));
    }
